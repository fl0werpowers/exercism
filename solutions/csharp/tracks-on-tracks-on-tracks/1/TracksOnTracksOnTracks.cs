public static class Languages
{
    ...
    {
        var output = new List<string>(languages);
        output.Reverse();
        return output;
    }

    public static bool IsExciting(List<string> languages) => languages.Count != 0 && (languages.First() == "C#" || (languages.ElementAt(1) == "C#" && (languages.Count == 2 || languages.Count == 3)));
